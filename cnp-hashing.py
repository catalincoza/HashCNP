...
# Liste de exemple de nume (poate fi extins)
prenume = ["Ion", "Maria", "Andrei", "Elena", "Cristian", "Ana", "Mihai", "Ioana"]
nume_familie = ["Popescu", "Ionescu", "Georgescu", "Dumitrescu", "Radu", "Matei", "Marin", "Vasile"]

def genereaza_nume():
    prenume_ales = random.choice(prenume)
...
def genereaza_cnp():
    ...
    # Generăm numele asociat CNP-ului
    nume = genereaza_nume()
...
numar_cnpuri = 1000000  # sau un număr mai mare
numar_sloturi = 1000
...
# Extragem datele pentru graf: numărul de CNP-uri per slot
...
# Căutarea CNP-urilor și înregistrarea numărului de iterații pentru fiecare
numar_iteratii = []
